...
<section className="min-h-screen flex items-center justify-center flex-col bg-gradient-to-b from-[#121212] to-[#2c2c2c] overflow-hidden font-sans">
  ...
  <div className="relative w-[400px] min-h-[400px] bg-[#121212] backdrop-blur-sm rounded-xl flex items-center justify-center shadow-2xl border border-white/50">
    <div className="w-full h-full pt-10 pl-10 pr-10 pb-5">
      <h2 className="text-white text-3xl font-semibold tracking-wider mb-10 relative after:content-[''] after:absolute after:left-0 after:bottom-[-10px] after:w-20 after:h-1 after:bg-white">
        Login Form
      </h2>
      <form onSubmit={handleSubmit}>
        ...
        <div className="mt-5 mb-5">
          {isPending ? (
            ...
            <button className="w-full bg-blue-600 text-white p-2 rounded-full font-semibold cursor-pointer shadow-md hover:bg-blue-700 transition-colors duration-300 transform hover:scale-105">
              Login
            </button>
          )}
        </div>
